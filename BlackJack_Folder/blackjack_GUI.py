...
class Ui_Player_ReadyWindow(QtCore.QObject):
    ...
    def bet_it(self):
        ...
        self.ok_pushButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.openWindow(self.playReadyWin))
        self.ok_pushButton.setText("OK")
        self.ok_pushButton.setGeometry(180, 170, 500, 200)

        # TESTING THIS ERROR
        sb.button_press.connect(self.openWindow(self.playReadyWin))
...
#############################
    ...
    def setupUi(self):
        self.playReadyWin.setObjectName("Player_ReadyWindow")
        self.playReadyWin.resize(WIDTH, HEIGHT)
        self.centralwidget = QtWidgets.QWidget(self.playReadyWin)
        self.centralwidget.setObjectName("centralwidget")
        ...
        self.ready_pushButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.bet_it(self.playReadyWin))
        ...
        self.playReadyWin.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(self.playReadyWin)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 610, 22))
        self.menubar.setObjectName("menubar")
        self.playReadyWin.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(self.playReadyWin)
        self.statusbar.setObjectName("statusbar")
        self.playReadyWin.setStatusBar(self.statusbar)
        self.retranslateUi(self.playReadyWin)
        QtCore.QMetaObject.connectSlotsByName(self.playReadyWin)

    # AUTOGENERATED TRANSLATION FROM GUI TO PYTHON
    def retranslateUi(self, Player_ReadyWindow):
        _translate = QtCore.QCoreApplication.translate
        self.playReadyWin.setWindowTitle(_translate("Player_ReadyWindow", "Player 1"))
