...
#############################
    ...
    def setupUi(self, Player_ReadyWindow):
        ...
        self.Player_ReadyWindow.setObjectName("Player_ReadyWindow")
        self.Player_ReadyWindow.resize(WIDTH, HEIGHT)
        self.centralwidget = QtWidgets.QWidget(self.Player_ReadyWindow)
        self.centralwidget.setObjectName("centralwidget")
        ...
        self.ready_pushButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.bet_it(self.Player_ReadyWindow))
